...
- Upgrade Pulumi, Golang, NodeJS. Added fieldes `color` for getting color
  output.

## 3.19.0 (2022-06-24)

- Upgrade Pulumi, Golang, NodeJS. Added fieldes for remove stack `downsert` and 
  changing version of Pulumi tool.
